...
import com.returnorder.PaymentServices.controller.CardController;
...
public class TestController {
	...
	public void testGetException() throws Exception {
		when(cardService.processPayment(Mockito.anyLong(), Mockito.anyDouble())).thenThrow(new CardNotFoundException());
		long cardnumber=1234567890;
		Double amt=5000.0;
		mockMvc.perform(get("/card/{cardNumber}/{charge}",cardnumber,amt)).andExpect(status().isNotFound());
	}
